...
public class Activity2 extends AppCompatActivity {
    String imgPath = null;
    String url = "http://ec2-65-2-11-52.ap-south-1.compute.amazonaws.com:5000/or";
            ...
            public void onFailure(final Call call, final IOException e) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(Activity2.this, "Something went wrong:" + " " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        call.cancel();
            ...
            public void onResponse(Call call, final Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    Activity2.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(Activity2.this, myResponse, Toast.LENGTH_LONG).show();
